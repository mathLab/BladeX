...
class CustomProfile(ProfileBase):
    ...
    :param numpy.ndarray xup_coordinates: 1D array that contains the X-components of the
        airfoil's upper surface
    :param numpy.ndarray xdown_coordinates: 1D array that contains the X-components of the
        airfoil's lower surface
    :param numpy.ndarray yup_coordinates: 1D array that contains the Y-components of the
        airfoil's upper surface
    :param numpy.ndarray ydown_coordinates: 1D array that contains the Y-components of the
        airfoil's lower surface
        
    If section parameters are given as input:
        
    :param numpy.ndarray chord_percentage: 1D array that contains the chord percentages
        of an airfoil section for which camber and thickness are measured
    :param numpy.ndarray camber_percentage: 1D array that contains the camber percentage
    ...
    :param numpy.ndarray thickness_percentage: 1D array that contains the thickness 
    ...
    def __init__(self, *args):
        ...
        if len(args) == 4:
            self.xup_coordinates = args[0]
            self.yup_coordinates = args[1]
            self.xdown_coordinates = args[2]
            self.ydown_coordinates = args[3]
            
        if len(args) == 6:
            self.chord_percentage = args[0]
            self.camber_percentage = args[1]
            self.thickness_percentage = args[2]
            self.chord_len = args[3]
            self.camber_max = args[4]
            self.thickness_max = args[5]
