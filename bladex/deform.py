...
class Deformation(object):
    ...
    def _plot_parametric_curve(self, param, original, ctrl_points, spline, rbf,
                               rbf_points, deformed, outfile):
        """
    ...
    def plot(self,
             ...
             outfile=None):
        """
        Plot the parametric curves for the specified input parameters. Several
