...
latex_documents = [
  (master_doc, 'bladex.tex', u'bladex Documentation',
   u'BladeX contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'bladex', u'bladex Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'bladex', u'bladex Documentation',
   author, 'bladex', 'One line description of project.',
   'Miscellaneous'),
]
