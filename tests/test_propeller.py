...
class TestPropeller(TestCase):
    ...
    def test_generate_propeller_not_string(self):
        ...
        prop = create_sample_blade_NACApptc()
        prop.apply_transformations(reflect=True)
        blade_solid = prop.generate_blade_solid(max_deg=2,
                                                display=False,
                                                errors=None)
        prop = Propeller(shaft_solid, blade_solid, 1)
    ...
    def test_generate_propeller(self):
        ...
        blade_solid = prop.generate_blade_solid(max_deg=2,
                                                display=False,
                                                errors=None)
        prop = Propeller(shaft_solid, blade_solid, 4)
